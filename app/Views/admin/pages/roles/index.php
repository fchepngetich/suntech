    ...
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="<?= base_url('admin/roles/create') ?>" class="btn btn-primary btn-sm ">Add Role</a>
            </div>
        </div>
    </div>
<div class="col-md-12">
            ...
            <table class="table table-sm table-hover table-striped table-borderless" id="roles-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
    <!-- Edit Link -->
    <a href="<?= base_url('admin/roles/edit/' . $role['id']) ?>" class="btn btn-warning" style="color: rgb(38, 94, 215);">
        <i class="icon-copy dw dw-edit2 mr-3"></i> Edit
    </a>
    
    <!-- Delete Link -->
    <a href="<?= base_url('admin/roles/delete/' . $role['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this role?');">
