    ...
    <div class="page-header ">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="<?= base_url('admin/subsubcategories/add-subsubcategory') ?>"
                    class="btn btn-primary btn-sm ">Add Subsubcategory</a>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($subsubcategories as $subsubcategory): ?>
                                <tr>
                                    <td><?= esc($subsubcategory['name']) ?></td>
                                    <td><?= esc($subsubcategory['subcategory_name']) ?></td>
                                    <td>
                                        <a href="/admin/subsubcategories/edit/<?= esc($subsubcategory['slug']) ?>"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <a href="/admin/subsubcategories/delete/<?= esc($subsubcategory['slug']) ?>"
