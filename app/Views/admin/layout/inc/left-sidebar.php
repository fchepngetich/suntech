<div class="left-side-bar">
    ...
    <li>
        <a href="<?= base_url('/admin/subcategories') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-folder"></span><span class="mtext">SubCategories</span>
        </a>
    </li>
    <li>
        <a href="<?= base_url('/admin/subsubcategories') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-folder-1"></span><span class="mtext">SubsubCategories</span>
        </a>
    </li>
    <li>
        <a href="<?= base_url('/admin/blogs') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-file"></span><span class="mtext">Blogs</span>
        </a>
    </li>
    <li>
    ...
    <li>
        <a href="<?= base_url('admin/roles') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-shield"></span><span class="mtext">Roles</span>
        </a>
    </li>
    <li>
        <a href="<?= base_url('admin/logs') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-clipboard"></span><span class="mtext">System Logs</span>
        </a>
    </li>
    ...
    <li>
        <a href="<?= base_url('/admin/profile') ?>" class="dropdown-toggle no-arrow">
            <span class="micon dw dw-head"></span>
